...
function Checkout() {
    ...
    const itemList = (item)=>{
        ...
        return(
            ...
            <div className=" text-start">
              ...
              <small className="text-body-secondary text-start">{item.category}</small>
            </div>
  ...
  return(
      ...
      <div className="col-md-7 col-lg-8 "/>
        <form className="needs-validation col-6 mx-5" novalidate="">
        <h4 className="mb-5 text-start ">Billing address</h4>
          ...
          <h4 className="mb-3 text-start">Payment</h4>
